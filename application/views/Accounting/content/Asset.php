			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<table class='table table-hover table-bordered table-striped'>		
		            	<thead>
		            		<th width="300">Asset</th>
		            		<th width="150">Date Issued</th>
		            		<th width="150">Status</th>						            		
		            	</thead>
		            	<tbody>
		            		<tr>
		            			<td width="300"><input id="view-asset-name" name="view-asset-name" lass='form-control' type='text' style="border: 1px; background: transparent;" readonly></td>
