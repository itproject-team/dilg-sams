...
<div>
						...
						<div class="box-body">
				            <div class="nav-tabs-custom">
				                <ul class="nav nav-tabs" style="margin-bottom: 20px;">
				                	<li class="active"><a href="#admin-all" data-toggle="tab">All</a></li>
				                	<li><a href="#admin-completed" data-toggle="tab">Completed</a></li>
				                	<li><a href="#admin-incomplete" data-toggle="tab">Incomplete</a></li>
				                  	<li><a href="#admin-confirmed" data-toggle="tab">Confirmed</a></li>
				                  	<li><a href="#admin-pending" data-toggle="tab">Pending</a></li>
				                  	<li><a href="#admin-rejected" data-toggle="tab">Rejected</a></li>
				                  	
				                </ul>
	                	
	                  			<div class="tab-content">
	                  				<div class="tab-pane active" id="admin-all">
					                  	<table id='admin-all-table' class='table table-bordered table-hover table-striped' width="100%">
					                  		<thead>
						                  		<th>RIS No</th>
						                  		<th>Status</th>
						                  		<th>Created By</th>
	                  				...
	                  				<div class="tab-pane" id="admin-completed">
				                    	<table id='admin-completed-table' class='table table-bordered table-hover table-striped' width="100%">
				                    		<thead>
						                  		<th>RIS No</th>
						                  		<th>Status</th>
						                  		<th>Created By</th>
				                 	...
				                 	<div class="tab-pane" id="admin-incomplete">
				                    	<table id='admin-incomplete-table' class='table table-bordered table-hover table-striped' width="100%">
				                    		<thead>
						                  		<th>RIS No</th>
						                  		<th>Status</th>
						                  		<th>Created By</th>
				                  	...
				                  	<div class="tab-pane" id="admin-pending">
					                  	<table id='admin-pending-table' class='table table-bordered table-hover table-striped' width="100%">
					                  		<thead>
						                  		<th>RIS No</th>
						                  		<th>Status</th>
						                  		<th>Created By</th>
				                  	...
				                  	<div class="tab-pane" id="admin-confirmed">
				                    	<table id='admin-confirmed-table' class='table table-bordered table-hover table-striped' width="100%">
				                    		<thead>
						                  		<th>RIS No</th>
						                  		<th>Status</th>
						                  		<th>Created By</th>
				                  	...
				                  	<div class="tab-pane" id="admin-rejected">
				                    	<table id='admin-rejected-table' class='table table-bordered table-hover table-striped' width="100%">
				                    		<thead>
						                  		<th>RIS No</th>
						                  		<th>Status</th>
						                  		<th>Created By</th>
	...
	<form id='save_dispense' action="<?php echo base_url(); ?>gss/head/ris/save_dispense" method='post'>
	...
	<form id='update_dispense' action="<?php echo base_url(); ?>gss/head/ris/update_dispense" method='post'>
