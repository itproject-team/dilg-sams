...
<html>
	...
	<body class="hold-transition skin-blue sidebar-mini">
	    <div class="wrapper">
	      	...
	      	<aside class="main-sidebar">
	        	<section class="sidebar">
	          		...
	          		<!-- 	<li class="<?php if($nav === 'reports'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>gss/head/reports"><i class="fa fa-file"></i> <span>Generated Reports</span></a></li> -->
      ...
      <script type="text/javascript" src="<?php echo base_url(); ?>/libs/angular/angular.min.js"></script>
			<script type="text/javascript" src="<?php echo base_url(); ?>/libs/datejs/date.js"></script>
